/**
 * v0 by Vercel.
 * @see https://v0.dev/t/nw85cbQF2rj
...
export default function Component() {
  return (
      ...
      <div className="flex flex-col">
        ...
        <main className="flex min-h-[calc(100vh_-_theme(spacing.16))] flex-1 flex-col gap-4 p-4 md:gap-8 md:p-1">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card>
              ...
              <CardContent>
                <div className="text-2xl font-bold">1258</div>
              </CardContent>
            </Card>
            <Card>
              <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
                <CardTitle className="text-sm font-medium">Valor médio da lista</CardTitle>
